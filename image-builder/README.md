...
- the installed pacman configuration is the runtime's aarch64 template for the channel, and the installed-system checks (`builder/verify_installed_system.py`) pass, `alsa-ucm-conf-asahi` and `asahi-audio` included
